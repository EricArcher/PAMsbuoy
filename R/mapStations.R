...
#' @param size size of points for graph
#'
...
#' @export
#'
mapStations <- function(stationList, zoom='auto', crop=FALSE, map=NULL, title='Sonobuoy Stations', size=3) {
  ...
  g <- map + geom_point(data=buoyPositions, aes(x=Longitude, y=Latitude, color='Station'), size=size) +
